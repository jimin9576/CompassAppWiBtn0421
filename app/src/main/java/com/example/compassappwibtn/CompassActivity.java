        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                switch (sensorEvent.sensor.getType()){
                    case Sensor.TYPE_ACCELEROMETER: accelValues = sensorEvent.values.clone(); break;
                    case Sensor.TYPE_MAGNETIC_FIELD: magneticValues = sensorEvent.values.clone(); break;
                    default: break;
                }
                if(magneticValues != null && accelValues != null) {
                    ...
                    sensorManager.getOrientation(R, values); //we'll use values[0] only
